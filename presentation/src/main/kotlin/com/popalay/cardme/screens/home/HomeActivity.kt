...
class HomeActivity : BaseActivity(), HasSupportFragmentInjector {
	...
	private fun initUI() {
		...
		pageAdapter = HomePageAdapter(this, supportFragmentManager)
	...
	// Shortcuts
	@Shortcut(
		id = "SHORTCUT_ADD_CARD",
		icon = R.drawable.ic_shortcut_add_card,
		rank = 0,
	...
	@Shortcut(
		id = "SHORTCUT_DEBTS",
		icon = R.drawable.ic_shortcut_debts,
		rank = 2,
		shortLabelRes = R.string.shortcut_debts
	)
	fun debtsShortcut() {
