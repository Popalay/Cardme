...
package com.popalay.cardme.utils.recycler.adapter;
 ...
 * case.
 */
abstract public class BaseDataBoundAdapter<T extends ViewDataBinding, M extends StableId>
    ...
    public void setItems(List<M> items) {
        ...
        if (oldItems.isEmpty()) {
            ...
            DiffUtil.calculateDiff(new DiffUtilCallback(oldItems, this.items), true)
